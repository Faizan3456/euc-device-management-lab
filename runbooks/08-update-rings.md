...
![Intune Windows update rings list showing Lab-Ring-Pilot-IT (0-day quality deferral) and Lab-Ring-Broad (7-day), both Running](../assets/screenshots/08-update-rings.webp)
